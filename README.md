# CDKTN Go bindings for kreuzwerker/docker provider version 3.6.2
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-docker/blob/main/docs/API.go.md).
