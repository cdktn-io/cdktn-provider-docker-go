...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-docker.dataDockerNetwork.DataDockerNetworkContainers",
		reflect.TypeOf((*DataDockerNetworkContainers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-docker.dataDockerNetwork.DataDockerNetworkContainersList",
		reflect.TypeOf((*DataDockerNetworkContainersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDockerNetworkContainersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
