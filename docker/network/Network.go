...
func (j *jsiiProxy_Network) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Network) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Network) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Network) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Network) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Network)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Network)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Network)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Network_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_Network) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_Network) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_Network) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_Network) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_Network) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
