...
func (n *jsiiProxy_NetworkIpamConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkIpamConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
