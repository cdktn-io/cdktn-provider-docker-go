...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipamOptionsInput", GoGetter: "IpamOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpamOptions", GoMethod: "ResetIpamOptions"},
