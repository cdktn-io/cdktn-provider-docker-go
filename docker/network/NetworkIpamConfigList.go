...
func (j *jsiiProxy_NetworkIpamConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkIpamConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkIpamConfigList {
	_init_.Initialize()
...
func NewNetworkIpamConfigList_Override(n NetworkIpamConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkIpamConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkIpamConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkIpamConfigList) Resolve(context cdktn.IResolveContext) interface{} {
