...
func (j *jsiiProxy_Secret) Data() *string {
	var returns *string
	_jsii_.Get(
		j,
		"data",
...
func (j *jsiiProxy_Secret) DataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataInput",
...
func (j *jsiiProxy_Secret) Labels() SecretLabelsList {
	var returns SecretLabelsList
	_jsii_.Get(
		j,
		"labels",
		&returns,
...
func (j *jsiiProxy_Secret) LabelsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_Secret) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Secret)SetData(val *string) {
...
func (s *jsiiProxy_Secret) PutLabels(value interface{}) {
...
func (s *jsiiProxy_Secret) ResetLabels() {
	_jsii_.InvokeVoid(
		s,
		"resetLabels",
		nil, // no parameters
