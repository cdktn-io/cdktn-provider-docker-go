...
func (j *jsiiProxy_SecretLabelsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecretLabelsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecretLabelsList {
	_init_.Initialize()
...
func NewSecretLabelsList_Override(s SecretLabelsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecretLabelsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecretLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecretLabelsList) Resolve(context cdktn.IResolveContext) interface{} {
