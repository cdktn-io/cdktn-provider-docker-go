...
func (s *jsiiProxy_Secret) validatePutLabelsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SecretLabels; received %#v (a %T)", value, value)
		}
	}
