...
func (p *jsiiProxy_Plugin) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (p *jsiiProxy_Plugin) validatePutGrantPermissionsParameters(value interface{}) error {
	...
	case *[]*PluginGrantPermissions:
		value := value.(*[]*PluginGrantPermissions)
	...
	case []*PluginGrantPermissions:
		value_ := value.([]*PluginGrantPermissions)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PluginGrantPermissions; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Plugin) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
