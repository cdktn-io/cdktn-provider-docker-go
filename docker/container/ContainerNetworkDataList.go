...
func (j *jsiiProxy_ContainerNetworkDataList) TerraformResource() cdktf.IInterpolatingParent {
...
func (c *jsiiProxy_ContainerNetworkDataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerNetworkDataList) Resolve(context cdktf.IResolveContext) interface{} {
