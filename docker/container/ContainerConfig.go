...
type ContainerConfig struct {
	...
	DeviceCgroupRules *[]*string `field:"optional" json:"deviceCgroupRules" yaml:"deviceCgroupRules"`
	...
	DeviceReadBps interface{} `field:"optional" json:"deviceReadBps" yaml:"deviceReadBps"`
	...
	DeviceReadIops interface{} `field:"optional" json:"deviceReadIops" yaml:"deviceReadIops"`
	...
	DeviceRequests interface{} `field:"optional" json:"deviceRequests" yaml:"deviceRequests"`
	// devices block.
	//
	...
	DeviceWriteBps interface{} `field:"optional" json:"deviceWriteBps" yaml:"deviceWriteBps"`
	...
	DeviceWriteIops interface{} `field:"optional" json:"deviceWriteIops" yaml:"deviceWriteIops"`
	// DNS servers to use.
	//
	...
	Timeouts *ContainerTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
