...
func (j *jsiiProxy_ContainerPortsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ContainerPortsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ContainerPortsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ContainerPortsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ContainerPortsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ContainerPortsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ContainerPortsList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ContainerPortsList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ContainerPortsList) Get(index *float64) ContainerPortsOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ContainerPortsOutputReference
...
func (c *jsiiProxy_ContainerPortsList) ToString() *string {
	var returns *string
