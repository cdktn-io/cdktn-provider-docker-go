...
import (
	...
	"github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/tag/internal"
...
func (j *jsiiProxy_Tag) SourceImage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceImage",
...
func (j *jsiiProxy_Tag) SourceImageId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceImageId",
...
func (j *jsiiProxy_Tag) SourceImageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceImageInput",
...
func (j *jsiiProxy_Tag) TargetImageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetImageInput",
...
func (j *jsiiProxy_Tag)SetSourceImage(val *string) {
...
func (j *jsiiProxy_Tag)SetTargetImage(val *string) {
	if err := j.validateSetTargetImageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (t *jsiiProxy_Tag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_Tag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
