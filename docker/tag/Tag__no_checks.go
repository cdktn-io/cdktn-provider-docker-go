...
func (t *jsiiProxy_Tag) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (t *jsiiProxy_Tag) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
...
func (j *jsiiProxy_Tag) validateSetSourceImageParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Tag) validateSetTagTriggersParameters(val *[]*string) error {
	return nil
}

func (j *jsiiProxy_Tag) validateSetTargetImageParameters(val *string) error {
	return nil
}
