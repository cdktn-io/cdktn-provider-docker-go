...
import (
	...
	"github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/datadockerlogs/internal"
...
func (j *jsiiProxy_DataDockerLogs) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataDockerLogs) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataDockerLogs) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDockerLogs) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataDockerLogs) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataDockerLogs)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDockerLogs)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDockerLogs)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDockerLogs_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDockerLogs) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDockerLogs) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDockerLogs) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
