...
func (j *jsiiProxy_Volume) Driver() *string {
	var returns *string
	_jsii_.Get(
		j,
		"driver",
...
func (j *jsiiProxy_Volume) DriverInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"driverInput",
...
func (j *jsiiProxy_Volume) DriverOpts() *map[string]*string {
...
func (j *jsiiProxy_Volume) DriverOptsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"driverOptsInput",
...
func (j *jsiiProxy_Volume) Labels() VolumeLabelsList {
	var returns VolumeLabelsList
	_jsii_.Get(
		j,
		"labels",
		&returns,
...
func (j *jsiiProxy_Volume) LabelsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_Volume) Mountpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mountpoint",
...
func (v *jsiiProxy_Volume) ResetDriver() {
	_jsii_.InvokeVoid(
		v,
		"resetDriver",
		nil, // no parameters
...
func (v *jsiiProxy_Volume) ResetDriverOpts() {
	_jsii_.InvokeVoid(
		v,
		"resetDriverOpts",
		nil, // no parameters
...
func (v *jsiiProxy_Volume) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
