...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-docker.volume.VolumeCluster",
		reflect.TypeOf((*VolumeCluster)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-docker.volume.VolumeClusterOutputReference",
		reflect.TypeOf((*VolumeClusterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "limitBytes", GoGetter: "LimitBytes"},
			_jsii_.MemberProperty{JsiiProperty: "limitBytesInput", GoGetter: "LimitBytesInput"},
			_jsii_.MemberProperty{JsiiProperty: "requiredBytes", GoGetter: "RequiredBytes"},
			_jsii_.MemberProperty{JsiiProperty: "requiredBytesInput", GoGetter: "RequiredBytesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLimitBytes", GoMethod: "ResetLimitBytes"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequiredBytes", GoMethod: "ResetRequiredBytes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTopologyPreferred", GoMethod: "ResetTopologyPreferred"},
			_jsii_.MemberMethod{JsiiMethod: "resetTopologyRequired", GoMethod: "ResetTopologyRequired"},
			...
			_jsii_.MemberProperty{JsiiProperty: "topologyPreferred", GoGetter: "TopologyPreferred"},
			_jsii_.MemberProperty{JsiiProperty: "topologyPreferredInput", GoGetter: "TopologyPreferredInput"},
			_jsii_.MemberProperty{JsiiProperty: "topologyRequired", GoGetter: "TopologyRequired"},
			_jsii_.MemberProperty{JsiiProperty: "topologyRequiredInput", GoGetter: "TopologyRequiredInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
