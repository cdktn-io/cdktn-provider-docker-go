...
func (j *jsiiProxy_RegistryImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RegistryImage) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RegistryImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RegistryImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RegistryImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RegistryImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewRegistryImage(scope constructs.Construct, id *string, config *RegistryImageConfig) RegistryImage {
	...
	if err := validateNewRegistryImageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RegistryImage)SetCount(val interface{}) {
...
func (j *jsiiProxy_RegistryImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RegistryImage)SetKeepRemotely(val interface{}) {
	if err := j.validateSetKeepRemotelyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RegistryImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RegistryImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RegistryImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRegistryImage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RegistryImage_IsConstruct(x interface{}) *bool {
	...
	if err := validateRegistryImage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RegistryImage_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRegistryImage_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RegistryImage_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRegistryImage_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RegistryImage) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RegistryImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RegistryImage) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RegistryImage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RegistryImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RegistryImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RegistryImage) MoveFromId(id *string) {
...
func (r *jsiiProxy_RegistryImage) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RegistryImage) MoveToId(id *string) {
...
func (r *jsiiProxy_RegistryImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RegistryImage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RegistryImage) ToHclTerraform() interface{} {
	var returns interface{}
