...
import (
	...
	"github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/buildxbuilder/internal"
...
func (j *jsiiProxy_BuildxBuilder) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BuildxBuilder) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BuildxBuilder) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BuildxBuilder) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BuildxBuilder) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BuildxBuilder)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BuildxBuilder)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BuildxBuilder)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BuildxBuilder_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BuildxBuilder) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BuildxBuilder) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BuildxBuilder) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BuildxBuilder) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BuildxBuilder) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BuildxBuilder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
