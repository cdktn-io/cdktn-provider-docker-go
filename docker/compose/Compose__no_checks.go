...
func (c *jsiiProxy_Compose) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (c *jsiiProxy_Compose) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
