...
import (
	...
	"github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/compose/internal"
...
func (c *jsiiProxy_Compose) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Compose) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
