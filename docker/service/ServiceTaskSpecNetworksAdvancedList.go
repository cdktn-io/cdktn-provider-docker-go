...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) InternalValue() interface{} {
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ServiceTaskSpecNetworksAdvancedList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) Get(index *float64) ServiceTaskSpecNetworksAdvancedOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ServiceTaskSpecNetworksAdvancedOutputReference
...
func (s *jsiiProxy_ServiceTaskSpecNetworksAdvancedList) ToString() *string {
	var returns *string
