...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "capAdd", GoGetter: "CapAdd"},
			_jsii_.MemberProperty{JsiiProperty: "capAddInput", GoGetter: "CapAddInput"},
			_jsii_.MemberProperty{JsiiProperty: "capDrop", GoGetter: "CapDrop"},
			_jsii_.MemberProperty{JsiiProperty: "capDropInput", GoGetter: "CapDropInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCapAdd", GoMethod: "ResetCapAdd"},
			_jsii_.MemberMethod{JsiiMethod: "resetCapDrop", GoMethod: "ResetCapDrop"},
