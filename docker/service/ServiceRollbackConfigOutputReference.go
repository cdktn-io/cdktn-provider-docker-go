...
func (s *jsiiProxy_ServiceRollbackConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceRollbackConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
