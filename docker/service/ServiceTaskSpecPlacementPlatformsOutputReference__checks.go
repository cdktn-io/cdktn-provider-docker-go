...
func (s *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ServiceTaskSpecPlacementPlatforms; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewServiceTaskSpecPlacementPlatformsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
