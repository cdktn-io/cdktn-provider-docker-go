...
func (s *jsiiProxy_ServiceTaskSpecContainerSpecHealthcheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceTaskSpecContainerSpecHealthcheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
