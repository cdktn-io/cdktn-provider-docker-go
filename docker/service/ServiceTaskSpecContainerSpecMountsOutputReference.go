...
func (s *jsiiProxy_ServiceTaskSpecContainerSpecMountsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceTaskSpecContainerSpecMountsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
