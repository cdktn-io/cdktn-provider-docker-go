...
func (s *jsiiProxy_Service) validatePutLabelsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServiceLabels; received %#v (a %T)", value, value)
		}
	}
