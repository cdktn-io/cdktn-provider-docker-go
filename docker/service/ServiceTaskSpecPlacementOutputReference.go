...
func (s *jsiiProxy_ServiceTaskSpecPlacementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceTaskSpecPlacementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
