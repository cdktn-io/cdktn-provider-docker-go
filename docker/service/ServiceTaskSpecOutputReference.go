...
func (s *jsiiProxy_ServiceTaskSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceTaskSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
