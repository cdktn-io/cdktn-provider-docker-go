...
import (
	...
	"github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/provider/internal"
...
func (d *jsiiProxy_DockerProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
