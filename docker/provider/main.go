...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableDockerDaemonCheck", GoGetter: "DisableDockerDaemonCheck"},
			_jsii_.MemberProperty{JsiiProperty: "disableDockerDaemonCheckInput", GoGetter: "DisableDockerDaemonCheckInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableDockerDaemonCheck", GoMethod: "ResetDisableDockerDaemonCheck"},
