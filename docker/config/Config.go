...
func (j *jsiiProxy_Config) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Config) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Config) Data() *string {
	var returns *string
	_jsii_.Get(
		j,
		"data",
...
func (j *jsiiProxy_Config) DataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataInput",
...
func (j *jsiiProxy_Config) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Config) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Config) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Config) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Config) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Config)SetCount(val interface{}) {
...
func (j *jsiiProxy_Config)SetData(val *string) {
...
func (j *jsiiProxy_Config)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Config)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Config)SetName(val *string) {
...
func (j *jsiiProxy_Config)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Config_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_Config) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_Config) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Config) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_Config) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Config) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Config) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Config) MoveFromId(id *string) {
...
func (c *jsiiProxy_Config) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_Config) MoveToId(id *string) {
...
func (c *jsiiProxy_Config) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Config) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_Config) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_Config) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
