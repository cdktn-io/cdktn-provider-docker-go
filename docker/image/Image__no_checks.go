...
func (i *jsiiProxy_Image) validatePutBuildAttributeParameters(value *ImageBuild) error {
	return nil
}
...
func (j *jsiiProxy_Image) validateSetForceRemoveParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Image) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
...
func (j *jsiiProxy_Image) validateSetTriggersParameters(val *map[string]*string) error {
	return nil
}
